export const content = {
  ...
  hiring: {
    ...
    body:
      "The pipeline: an immersive online assessment (multimedia-based, ~80-100 minutes, blending numerical reasoning, verbal reasoning, and situational judgment — not a standard SHL test), a recruiter phone screen, Round 1 interviews (behavioral + case for consulting; scenario-based for audit), and a Round 2 or assessment center that adds a group case exercise and, for graduate tracks, a presentation round. The final partner interview runs 40-90 minutes with no fixed structure — the partner is asking: \"Would I bring this person to a client meeting tomorrow?\" For audit/assurance roles, cases are replaced by Deloitte's Scenario Interview Tool, which covers audit judgment calls, financial statement interpretation, and client interaction scenarios.",
  },
  lookFor: {
    heading: "What Deloitte Looks For",
    body:
      "Deloitte cases are candidate-led — you define the problem, structure the approach, and drive the analysis. Waiting to be guided is the most common case failure. Deloitte uses the SOAR behavioral framework (Situation, Obstacle, Action, Result), not just STAR — the Obstacle component is deliberate, designed to surface real friction and judgment rather than polished success stories. In the group case, both dominating the room and going silent are evaluated negatively; they specifically watch for whether you bring in quieter voices. A specific, practice-referenced \"Why Deloitte?\" is essential at the partner stage — generic Big 4 answers are the most-cited partner-round rejection reason.",
  },
  tips: [
    ...
    "Prepare for the immersive assessment with practice that mixes question types, not standard SHL banks — it shifts cognitive modes frequently",
    "Have a specific 'Why Deloitte?' answer that references a practice area, named initiative, or recent client work — 'great culture and training' gets you cut at the partner round",
  ],
  ctaCompany: "Deloitte",
};
